...
I like this story because it paints a picture of how we thought the world should be, and how I still think it should be 10 years later. It *should* have been that easy to wire together, *on our phones, while hiking*. Especially for some kids that just knew basic web programming and had a cool idea. 
